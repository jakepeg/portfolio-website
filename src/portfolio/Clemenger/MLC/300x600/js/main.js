...
function addEventListeners(){
    bannerContent.onclick = triggerClickthrough;
		...
		startAnimation = function() {			
	        ...
	        .from('#iconstrip', 0.3, {top: 200, ease: Power4.easeInOut})
            ...
            .to('#iconstrip', 0.3, {top: -400, ease: Power4.easeInOut},'+=2')
            .to('#labelstrip', 0.3, {top: -100, ease: Power4.easeInOut})
            .to('#iconstrip', 0.3, {top: -600, ease: Power4.easeInOut},'+=2')
            ...
            .to('#iconstrip', 0.1, {top: -800, opacity: 0, ease: Power4.easeInOut},'-=0.1')
			...
			.from('#disclaimer_button', 0.3, {top:600, opacity: 0, ease: Power4.easeInOut});
		};
